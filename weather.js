...
// window.onload = info;
// async function info(){
//     await fetch("https://api.openweathermap.org/data/2.5/weather?q=taiyuan&appid=26a7dca7e46fbceb5fa3f089a727767c").then(res=>{
//         return res.json();
//     }).then(result=>{
...
function handleError() {
    alert('error')
    fetch("https://api.openweathermap.org/data/2.5/weather?q=beijing&appid=26a7dca7e46fbceb5fa3f089a727767c").then(res => {
        return res.json();
    }).then(result => {
        var SPtemperature = document.getElementsByClassName('SPtemperature');
        var SPwind = document.getElementsByClassName('wind');
